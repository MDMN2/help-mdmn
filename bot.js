...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            .setColor("RANDOM")
            .setThumbnail(message.author.avatarURL)
            .setDescription(`**__مساعد مدمن | Version 1.1__ 
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/f436jRW 
            **`);
            message.channel.sendEmbed(help); // رابط السيرفر يعود الى سيرفر MDMN .
    }
});
